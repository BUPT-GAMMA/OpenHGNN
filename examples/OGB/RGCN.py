...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_bases', default='40', type=int)
    ...
    myNCDataset = AsNodeClassificationDataset(MyNCDataset(dataset_name = "mag"), target_ntype='paper',
                                            force_reload=True)
    experiment = Experiment( model='RGCN', dataset=myNCDataset,
                            task='node_classification', gpu = args.gpu, mini_batch_flag = args.mini_batch_flag, 
                            max_epoch=args.max_epoch, batch_size=args.batch_size, in_dim = args.in_dim, n_bases = args.n_bases,
