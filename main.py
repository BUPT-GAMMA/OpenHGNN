...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', default='MeiREC', type=str, help='name of models')
    parser.add_argument('--task', '-t', default='meirec', type=str, help='name of task')
    # link_prediction / node_classification
    parser.add_argument('--dataset', '-d', default='meirec', type=str, help='name of datasets')
