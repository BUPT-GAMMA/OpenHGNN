...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d', default='aifb', type=str, help='name of datasets')
    ...
    parser.add_argument('--vis_emb', default=False, action='store_true', help='visualize the output embedding')
