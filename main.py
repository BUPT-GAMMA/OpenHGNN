...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_list', default='4,5', type=str, help='will train on which GPUs')
    parser.add_argument('--port', default='12371', type=int, help='port used for distributed training')
    ...
    experiment = Experiment(model=args.model, dataset=args.dataset, task=args.task, gpu=args.gpu,
                            ...
                            mini_batch_flag=args.mini_batch_flag, batch_size=args.batch_size, gpu_list = args.gpu_list, use_distributed = args.use_distributed, port=args.port)
