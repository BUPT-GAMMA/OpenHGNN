...
class NBF_Dataset():
    ...
    def __init__(self, root, name, version, transform=None, pre_transform=None):#   root/name/version == ~/zzh/WN18RR/v1
...
class NBF_Data():
    def __init__(self,
        ...
        super().__init__()
        # target_edge_idex是用来做预测的三元组，对应torch的dataloader需要提取的内容
...
def files_exist(files: List[str]) -> bool: # 判断文件是否存在
