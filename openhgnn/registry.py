...
def get_supported_datasets() -> list[str]:
    values = _evaluate_module_assignments(
        PACKAGE_ROOT / "dataset" / "__init__.py",
        DATASET_LIST_NAMES | {"CLASS_DATASETS", "SUPPORTED_DATASETS"},
    )
    ...
    datasets.update(values.get("SUPPORTED_DATASETS", {}).keys())
