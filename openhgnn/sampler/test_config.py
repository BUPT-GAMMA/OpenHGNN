CONFIG={
    ...
    'encoder_type': 'RotateE', 'inter_attn_feats': 128, 'num_heads': 8, 'num_layers': 2, 'out_dim':3,
    'dataset': 'imdb4MAGNN', 'category':'M', 'batch_size':1, 'device':'cuda:0', 'num_samples':5, 'num_workers':0
}