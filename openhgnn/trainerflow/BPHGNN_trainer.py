...
def load_our_data(dataset_str, cuda=True):  
    ...
    Avoid awful code
    """
    data = loadmat('/home/bjf/OpenHGNN/openhgnn/dataset/data/BPHGNN_dataset/alibaba_small.mat')
    # label
    try:
        labels = data['label']  
    except:
    ...
    # # # alibaba_small
    t_v_t=loadmat('/home/bjf/OpenHGNN/openhgnn/dataset/data/BPHGNN_dataset/alibaba_small_20.mat')
...
def load_data(dataset, datasetfile_type):
    ...
    if datasetfile_type == 'mat':
        data = sio.loadmat('/home/bjf/OpenHGNN/openhgnn/dataset/data/BPHGNN_dataset/alibaba_small.mat')
    else:
        pass
    try:
        labels = data['label']
    ...
    t_v_t=sio.loadmat('/home/bjf/OpenHGNN/openhgnn/dataset/data/BPHGNN_dataset/alibaba_small_20.mat')
    idx_train = t_v_t['train_idx'].ravel()
    idx_val = t_v_t['valid_idx'].ravel()
    idx_test = t_v_t['test_idx'].ravel()
...
class BPHGNN_trainer(BaseFlow):

    def __init__(self, args):
        super(BPHGNN_trainer, self).__init__(args)
        
        self.encode=torch.tensor(np.loadtxt('/home/bjf/OpenHGNN/openhgnn/dataset/data/BPHGNN_dataset/alibaba_small_encode.txt')) 
        mat=loadmat('/home/bjf/OpenHGNN/openhgnn/dataset/data/BPHGNN_dataset/alibaba_small.mat')
        try:
            train = mat['A']
        except:
            try:
